public class Presenter_Take_Pill extends Presenter {

    

    public Presenter_Take_Pill (String user_id, String function, List<String> parameters, Client client){
    ...
    */
    ...
    public ArrayList<String> present_Take_Pill (List<String> parameters){
        // Preparar la query
