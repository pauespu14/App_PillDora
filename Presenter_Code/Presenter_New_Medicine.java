public class Presenter_New_Medicine extends Presenter {
    ...
    public Presenter_New_Medicine (String user_id, String function, List<String> parameters, Client client){
    ...
    */
    ...
    public ArrayList<String> present_new_medicine (List<String> parameters){
        // Preparar la query
