public class Presenter_Treatments extends Presenter {
    ...
    public Presenter_Treatments (String user_id, String function, List<String> parameters, Client client){
    ...
    */
    ...
    public ArrayList<String> present_Treatments (List<String> parameters){
        // Preparar la query
