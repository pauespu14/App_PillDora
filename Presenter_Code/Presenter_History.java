public class Presenter_History extends Presenter {

    

    public Presenter_History (String user_id, String function, List<String> parameters, Client client){
    ...
    */
    ...
    public ArrayList<String> present_Calendar (List<String> parameters){
        // Preparar la query
