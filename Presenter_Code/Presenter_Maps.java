public class Presenter_Maps extends Presenter {

    

    public Presenter_Maps (String user_id, String function, List<String> parameters, Client client){
    ...
    */
    ...
    public ArrayList<String> present_maps (List<String> parameters){
        // Preparar la query
