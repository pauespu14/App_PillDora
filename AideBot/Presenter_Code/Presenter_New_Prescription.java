public class Presenter_New_Prescription extends Presenter {
    ...
    public Presenter_New_Prescription (String user_id, String function, List<String> parameters, Client client){
    ...
    */
    ...
    public ArrayList<String> present_new_prescription (List<String> parameters){
        // Preparar la query
