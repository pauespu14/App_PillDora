public class Presenter_Inventory extends Presenter {
    ...
    public Presenter_Inventory (String user_id, String function, List<String> parameters, Client client){
    ...
    */
    ...
    public ArrayList<String> present_inventory (List<String> parameters){
        // Preparar la query
